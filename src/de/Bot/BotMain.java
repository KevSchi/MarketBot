...
public class BotMain {
	...
	public static final String BASE_URL = "https://hackathon-game.relaxdays.cloud";
	...
	static String auth = PLAYER_ID + ":" + "+wUshSS8PNniFaDf7bqEul1Vk9ED/fJt";
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		while (true) {
			...
			// * Passt die Preise für diesesn Durchlauf an
			Listing.updateBestPrices();

			// getMostTags(10, artarr);
			Methods.updatePrices(supplierArray);

			// Einlesen self Infostring und convert 2 Json um Cash auszulesen
			// ? Ausgabe in den Elsezweig
			if (timeGone <= 5076000) { // 23,5*60*60 = Sekundenanzahl
			...
			logger.info("Der Bot lief " + runCount++ + " - Dies ist mein Geld: " + MyCash);
